  ...
  return (
    ...
    >
        ...
        <div className=' md:flex gap-5'>
            <div className=' md:h-[350px] max-w-[650px]: bg-secondary-color py-10 px-5' >
              ...
              <p className='text-left mt-6 font-normal md:text-xl '>
                "Introducing our Blockchain Mail Service, where secure identities from our Blockchain Name Service converge with encrypted communications, ensuring your messages are safe and trusted."
              </p> 
              <div>
