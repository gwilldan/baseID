...
function Footer() {
  ...
  return (
    <div className="pt-5 dark:font-semibold dark:text-white py-4 px-small md:px-Large grid justify-center md:grid-cols-2 md:justify-items-between">
      <p className="font-semibold"> 2023 Wallet ID</p>
